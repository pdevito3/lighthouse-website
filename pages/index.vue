  ...
  <div class="bg-gray-100 h-full">
    <div>
      <div class="pt-64 w-full flex justify-center">
        <p
          class="text-5xl text-gray-800 font-bold text-center"
      ...
      <div class="flex justify-around py-32">
        <div>
          <svg
            ...
            viewBox="0 0 24 24"
            class="h-32 w-32 fill-current text-blue-300"
          >
            <path
              class="primary"
        ...
        <div>
          ...
          >
            <rect
              class="text-white heroicon-monitor-edge heroicon-component-accent heroicon-component-fill"
              width="98"
              height="78"
              x="1"
              y="11"
